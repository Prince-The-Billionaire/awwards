  ...
  return (
    <div className='bg-black py-10 '>
        <div className=' flex flex-col gap-6 items-center'>
            ...
            <h1 className={`text-white text-8xl text-center ${zentryRegular.className}`}>STORY OF <br/> A HIDDEN REALM</h1>
            <img ref={divref} onMouseLeave={() => endmove(divref)} onMouseMove={(e) => mouseover(e,divref)} src='/img/entrance.webp' alt='entrance' className='object-cover rounded-2xl w-[800px] h-[500px] z-10 -mt-12 skew-x-3 rotate-z-6 mix-blend-difference mb-10'/>
            <div className='ml-auto mt-20 pr-10'>
